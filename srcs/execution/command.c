...
/*   Updated: 2025/05/08 18:14:23 by ego              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * `TEXT` as arguments. It skips redirections and stops when encountering a
 ...
 * @param t Token list.
 * 
 * @return Allocated filled command structure, NULL if memory allocation fails.
 */
