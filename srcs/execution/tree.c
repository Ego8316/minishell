 ...
 *
 * @brief - CMD nodes: expand and execute via `execute_pipeline`.
 * @brief - AND/OR nodes: execute left branch, then conditionally right.
 *
 ...
 *
 * @brief - CMD nodes are shown with their tokens.
 * @brief - AND/OR nodes are shown with branching.
 * @brief - Optional header displays borders around the output.
 *
