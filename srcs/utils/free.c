...
/**
 * @brief Frees every entry in a NULL-terminated array of strings.
 * 
...
/**
 * @brief Frees an entire variable list (identifier and value included).
 * 
...
/**
 * @brief Frees all dynamic fields inside the data structure.
 * 
